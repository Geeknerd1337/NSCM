...
////// Emissive:
                ...
                float2 node_1010 = float2((i.uv0.r+(sin(((i.uv0.g*_glitchSize)+(_glitchAnimSpeed*node_8662.g)))*_glitchAmt)),i.uv0.g);
                float4 _tex_var = tex2D(_tex,TRANSFORM_TEX(node_1010, _tex));
                ...
                float3 emissive = (_gamma*lerp(float3((_tex_var.r*lerp((node_1311_if_leA*node_9616)+(node_1311_if_leB*node_9616),node_2279,node_1311_if_leA*node_1311_if_leB)),(_tex_var.g*lerp((node_8627_if_leA*node_9616)+(node_8627_if_leB*node_9616),node_2279,node_8627_if_leA*node_8627_if_leB)),(_tex_var.b*lerp((node_2567_if_leA*node_9616)+(node_2567_if_leB*node_9616),node_2279,node_2567_if_leA*node_2567_if_leB))),_tex_var.rgb,_influence)*saturate(((1.0 - saturate(lerp((node_1351_if_leA*node_4411)+(node_1351_if_leB*node_4411),1.0,node_1351_if_leA*node_1351_if_leB)))+_scanLineBrightness))*saturate((_largeScanAmt+pow((sin(((_largeScanSize*i.uv0.g)+(_largeScanSpeed*node_5523.g)))*0.5+0.5),_largeScanFalloff))));
/// Final Color:
