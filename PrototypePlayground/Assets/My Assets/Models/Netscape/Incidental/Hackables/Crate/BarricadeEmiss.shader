...
////// Emissive:
                ...
                float scanlines = saturate(((sin((i.uv0.g*_scanlineTile))*0.5+0.5)+(1.0 - _scanLineStrength)));
                float3 emissive = lerp((_noiseTex_var.rgb*_noiseStrength*_backColor.rgb),((_Color.rgb*_text_var.rgb*scanlines)-(_textNoiseStrength*_noiseTex_var.r)),_text_var.r);
